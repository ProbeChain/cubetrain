...
BOOST_FIXTURE_TEST_CASE( bootseq_test, bootseq_tester ) {
    try {
        ...
        const auto first_june_2018 = fc::seconds(1541865600); // 2018-11-11
        const auto first_june_2028 = fc::seconds(1857484800); // 2028-11-11
        // Ensure that now is yet 10 years after 2018-11-11 yet
